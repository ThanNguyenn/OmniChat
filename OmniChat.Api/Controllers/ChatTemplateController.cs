...
namespace OmniChat.Api.Controllers
{
    ...
    public class ChatTemplateController : BaseController<ChatTemplateController>
    {
            ...
            [FromQuery] string? search = null)
        {
            ...
            var response = ApiResponseBuilder.BuildResponse(StatusCodes.Status200OK, "Get ChatTemplate successfully", result);
        ...
        public async Task<IActionResult> CreateChatTemplateAsync([FromBody] ChatTemplateRequest request)
        {
            ...
            var response = ApiResponseBuilder.BuildResponse(StatusCodes.Status201Created, "Create ChatTemplate successfully", result);
        ...
        public async Task<IActionResult> UpdateChatTemplateAsync([FromRoute] Guid id, [FromBody] ChatTemplateRequest request)
        {
            ...
            var response = ApiResponseBuilder.BuildResponse(StatusCodes.Status200OK, "Update ChatTemplate successfully", result);
            return StatusCode(StatusCodes.Status200OK, response);
        }
        ...
        public async Task<IActionResult> DeleteChatTemplateAsync([FromRoute] Guid id)
        {
            ...
            var response = ApiResponseBuilder.BuildResponse(StatusCodes.Status200OK, "Delete ChatTemplate successfully", result);
            return StatusCode(StatusCodes.Status200OK, response);
        }
    }
}
