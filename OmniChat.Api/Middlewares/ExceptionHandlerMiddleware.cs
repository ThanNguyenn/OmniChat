...
using ValidationException = OmniChat.Infrastructure.Exceptions.ValidationException;
        ...
        var (statusCode, message, reason, additionalData) = exception switch
        {
           ...
           ValidationException validationEx =>
            ...
            BusinessException businessEx =>
                (HttpStatusCode.UnprocessableContent, "Business rule violation", businessEx.Message, null),
